...
<p>
In order to download osTicket theres a lot of prerequesites. To start, Inside of a Windows VM I created in azure... I went to Control Panel, and to pressed "uninstall or change a program". From there on the left I clicked "Turn windows features on or off". After, I checked the boxes for "World Wide Web Services-> Application Development Features -> and CGI" this gives osTicket a web server to run on and CGI lets IIS (Internet Information Services) understand and execute PHP code (what osTicket uses).
</p>
<br />
